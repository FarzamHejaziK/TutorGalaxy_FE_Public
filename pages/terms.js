      ...
      <div data-custom-class='body'>
        ...
        <div align='center' style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className='question'>
                  <a
                    href='https://tutor-galaxy.com'
                    target='_blank'
                    data-custom-class='link'
                  >
                    https://tutor-galaxy.com
                  </a>
                </bdt>
              </span>{" "}
          ...
          >
            ...
            >
              ...
              <bdt className='block-component'>
                email at{" "}
                <bdt className='question'>ccpa.tutorgalaxy@gmail.com</bdt>
          ...
          >
            ...
            >
              ...
              <bdt className='statement-end-if-in-editor' />
              ), and <bdt className='question'>Tutor Galaxy</bdt>, concerning
          ...
          >
            ...
            >
              ...
              <bdt className='question'>ccpa.tutorgalaxy@gmail.com</bdt>, as
        ...
        <div align='center' style={{ textAlign: "left" }}>
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#law'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>11. GOVERNING LAW</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#corrections'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>13. CORRECTIONS</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#disclaimer'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>14. DISCLAIMER</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#indemnification'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>16. INDEMNIFICATION</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#userdata'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>17. USER DATA</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#misc'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>20. MISCELLANEOUS</span>
              </span>
            </a>{" "}
          ...
          <div className='MsoNormal' style={{ lineHeight: "1.5" }}>
            <a data-custom-class='link' href='#contact'>
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class='body_text'>21. CONTACT US</span>
              </span>
            </a>
          </div>
        </div>
        ...
        <div align='center' style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className='question'>ccpa.tutorgalaxy@gmail.com</bdt>. If we
            ...
            >
              ...
              >
                ...
                >
                  ...
                  . <bdt className='question'>Tutor Galaxy</bdt> and yourself
              ...
              >
                ...
                <span style={{ fontSize: 15 }}>
                  ...
                  HAVE A JURY TRIAL. <bdt className='block-component' />
              ...
              >
                <span style={{ fontSize: 15 }}>
                  ...
                  in any way to the Services be commenced more than{" "}
                  <bdt className='question'>one (1)</bdt> years after the cause
                  of action arose.{" "}
                  <bdt className='statement-end-if-in-editor' />
                          ...
                          >
                            <bdt data-type='conditional-block'>
                              ...
                              <bdt data-type='body'>
                                ...
                                <bdt className='question'>$1,000.00 USD</bdt>
                                <bdt className='statement-end-if-in-editor' />
                                <bdt className='block-component' />
                              </bdt>
                            </bdt>
